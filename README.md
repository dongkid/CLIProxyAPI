...
> **Dongkid Fork** — The following modifications have been made over upstream:
> - DeepSeek reasoning compatibility (empty thinking block preservation, effort level restoration, empty `reasoning_content` round-trip fix in response translator)
> - Maintain and develop usage statistics functionality
